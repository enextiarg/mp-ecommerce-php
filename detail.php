                            ...
                            <div class="width:60%">
                                ...
                                <?php
                                    ...
                                    $preference->back_urls = array(
                                        "success" => "https://enextimp.herokuapp.com/success.php",
                                        "failure" => "https://enextimp.herokuapp.com/failure.php",
                                        "pending" => "https://enextimp.herokuapp.com/pending.php"
                                    );
                                    $preference->notification_url = "https://enextimp.herokuapp.com/ipn.php";
                                    $preference->auto_return = "approved";
                                    $preference->external_reference = 'manuel@romero.com.ar';
                                    $preference->save();
